 ...
 *
 * <p>This is the only way the first Account comes into existence: the system ships zero Accounts and
 * issues no recovery key, so the password given here cannot be recovered.
 *
 * @param administratorName the name the person installing typed, with nothing prefilled or suggested
